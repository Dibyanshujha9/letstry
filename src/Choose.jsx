            ...
            <div className='row g-4'>
                <div className='col-lg-4'>
                    <Card className='d-flex align-items-center border-0 h-100'>
                        <div className='mt-3'>
                            <svg xmlns="http://www.w3.org/2000/svg" width="48" height="48" fill="#007bff" class="bi bi-trophy-fill" viewBox="0 0 16 16">
                        ...
                        <Card.Body>
                            ...
                            Our company has achieved notable success by organizing numerous workshops on drone systems and AI.                            </Card.Text>
                        </Card.Body>
                    </Card>
                </div>
                <div className='col-lg-4'>
                    <Card className='d-flex align-items-center border-0 h-100'>
                        <div className='mt-3'>
                            <svg xmlns="http://www.w3.org/2000/svg" width="48" height="48" fill="#007bff" class="bi bi-emoji-smile-fill" viewBox="0 0 16 16">
                        ...
                        <Card.Body>
                            ...
                            <Card.Text className='text-center'>
                            We ensure our students are content and satisfied with personalized support and engaging activities.                            </Card.Text>
                        </Card.Body>
                    </Card>
                </div>
                <div className='col-lg-4'>
                    <Card className='d-flex align-items-center border-0 h-100'>
                        <div className='mt-3'>
                            <svg xmlns="http://www.w3.org/2000/svg" width="48" height="48" fill="#007bff" class="bi bi-geo-alt-fill" viewBox="0 0 16 16">
                        ...
                        <Card.Body>
                            ...
                            <Card.Text className='text-center'>
                            Location in India: Dinhata, West Bengal 736135, India.                            </Card.Text>
                        </Card.Body>
                    </Card>
                </div>
            </div>
